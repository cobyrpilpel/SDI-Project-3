...
{var ingredientsToAdd = vodkaSauceParts;
...
{var howLongToCool = serveTime / (coolTime, thickenTime);
	console.log("After you are done cooking your sauce you need to let it cool for " + howLongToCool + " minutes or you will end up burning yourself.");
